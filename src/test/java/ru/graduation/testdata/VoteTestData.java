...
public class VoteTestData {
    ...
    public static final Vote VOTE_2 = new Vote(100020, LocalDate.of(2020, 03, 25), UserTestData.USER, RESTAURANT_1);
    public static final Vote VOTE_3 = new Vote(100021, LocalDate.of(2020, 03, 24), ADMIN, RestaurantTestData.RESTAURANT_2);
    public static final Vote VOTE_4 = new Vote(100022, LocalDate.of(2020, 03, 24), UserTestData.USER, RESTAURANT_1);
    public static final Vote VOTE_5 = new Vote(100023, LocalDate.of(2020, 03, 23), ADMIN, RestaurantTestData.RESTAURANT_2);
    public static final Vote VOTE_6 = new Vote(100024, LocalDate.of(2020, 03, 23), UserTestData.USER, RestaurantTestData.RESTAURANT_2);
